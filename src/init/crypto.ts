 ...
 *
 * On rejection the cache is cleared so the next call retries from scratch — a
 * one-off init failure (e.g. transient artifact fetch) doesn't poison every
 * subsequent SDK operation.
